...
public class CashCardJaonTest {
    ...
    void cashCardSerializationTest() throws IOException {
        ...
        assertThat(json.write(cashCard)).isStrictlyEqualToJson("expectedCashCard.json");
    ...
    void cashCardListSerializationTest() throws IOException {
        assertThat(jsonList.write(cashCards)).isStrictlyEqualToJson("expectedCashCardList.json");
    }
